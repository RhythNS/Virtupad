...
namespace VRKeys {
	...
	public class Layout {
        ...
        {
			public string key, shifted;
			public uDesktopDuplication.KeyBoard.Keys keyValue;
			public uDesktopDuplication.KeyBoard.Keys keyShiftedValue;
			public bool hasShiftedValue;
        }
		...
		public LayoutKey[] row1Keys;// = { { "`" }, "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "-", "=" };
									
		public LayoutKey[] row2Keys;// = { "q", "w", "e", "r", "t", "y", "u", "i", "o", "p", "[", "]", "\\" };
									
		public LayoutKey[] row3Keys;// = { "a", "s", "d", "f", "g", "h", "j", "k", "l", ";", "'" };
									
		public LayoutKey[] row4Keys; // = { "z", "x", "c", "v", "b", "n", "m", ",", ".", "?" };
