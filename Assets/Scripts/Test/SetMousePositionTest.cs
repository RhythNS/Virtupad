...
namespace Virtupad
{
    public class SetMousePositionTest : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                Manager.keyBoard.SendKeyDown(KeyBoard.Keys.LWIN);
                Manager.keyBoard.SendKeyDown(KeyBoard.Keys.keyD);
                Manager.keyBoard.SendKeyUp(KeyBoard.Keys.LWIN);
                Manager.keyBoard.SendKeyUp(KeyBoard.Keys.keyD);
            }
        }
    }
}
